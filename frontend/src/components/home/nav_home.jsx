...
const Nav_home = () => {
    return (
        <div className='w-[560px] h-[560px]  flex items-center justify-center relative'>
            ...
            <NavLink className='bg-yellow-500 absolute right-[-15px] p-2 rounded-full'>
            ...
            {/* link about_me */}
            <NavLink to="/AboutMe" className='bg-yellow-500 absolute right-1 top-40 p-2 rounded-full'>
            ...
            <NavLink className='bg-yellow-500 absolute right-1 bottom-40 p-2 rounded-full'>
                <svg
                    width="25px"
                    height="25px"
                    viewBox="0 0 24 24"
		...
		c-2.4-0.1-4.5-1.2-6-2.9V25c0,1.7,1.3,3,3,3h20c1.7,0,3-1.3,3-3v-6.9C27.5,19.8,25.4,20.9,23,21z"/>
            ...
            <NavLink className='bg-yellow-500 absolute right-14 bottom-21 p-2 rounded-full'>
